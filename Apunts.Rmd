...
6. Fonts de variació ambiental. El fenotip depén de factors genètics i ambientals,
...
7. Heretabilitat. Definim l'heretabilitat i poc més.
...
de la variància fenotípica és molt difícil de mesurar i sempre pot contribuir a la variància
observada. Un exemple d'aquesta confusió són els efectes materns, que són ambientals, però
...
la variació de la no-additivitat entre els efectes ambiental i genètic. Una $\sigma_I^2$
es pot entendre com una diversitat de pendents en les normes de reacció, amb algunes normes
de reacció paral·leles entre elles i d'altres molt divergents. Mentre que $\sigma_{G,E}$
parla de la freqüència amb què trobem individus d'un cert genotip en un cert ambient.
...
L'heretabilitat (en sentit estricte) d'un caràcter quantitatiu és la proporció de la
variància fenotípica d'una població que es pot atribuir a la variància de valors
